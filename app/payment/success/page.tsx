  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md text-center animate-fade-in">
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6 text-left max-w-md mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-medium py-2 px-4 rounded-lg transition-colors w-full justify-center"
          >
